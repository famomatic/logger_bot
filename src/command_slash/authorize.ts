...
export const command = {
  data: new SlashCommandBuilder()
    ...
    .addStringOption(o => o.setName('guild_id').setDescription('승인할 길드 ID').setRequired(true))
  ...
  async execute(interaction: ChatInputCommandInteraction) {
    ...
    await interaction.reply({ content: `✅ 길드 ${gid} 이(가) 승인되었습니다.`, flags: MessageFlags.Ephemeral });
  }
};
