import { SlashCommandBuilder, ChatInputCommandInteraction, version as djsVersion, EmbedBuilder, Colors, WebSocketShardStatus } from 'discord.js';
        ...
        try {
            ...
            if (client.application) {
                try {
                    ...
                    logger.warn('Failed to fetch application commands for slash status:', fetchError);
            ...
            logger.error('Full error object for slash status:', JSON.stringify(err, Object.getOwnPropertyNames(err)));
