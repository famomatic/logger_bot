...
export const eventConfigurations: Record<string, EventConfig> = {
  ...
  guildMemberUpdate: {
    ...
    searchableFields: [
        'memberId', 'memberTag', 
        'changes.nickname.old', 'changes.nickname.new', 
        'changes.roles.added', 'changes.roles.removed', // Array of role IDs/names
        'changes.avatar.old', 'changes.avatar.new',
        'executorId'
    ],
    includeInChoices: true,
  },
  ...
  userUpdate: {
    ...
    category: 'user',
    searchableFields: ['userId', 'oldUsername', 'newUsername', 'oldDiscriminator', 'newDiscriminator', 'oldAvatar', 'newAvatar'],
  ...
  voiceStateUpdate: {
    ...
    searchableFields: [
        'memberId', 'memberTag', 
        'oldChannelId', 'newChannelId', 'currentChannelId',
  ...
  guildScheduledEventCreate: {
    ...
    searchableFields: ['eventId', 'eventName', 'channelId', 'creatorId', 'description', 'scheduledStartTime', 'entityType'],
    includeInChoices: false,
  },
  ...
  guildScheduledEventUpdate: {
    ...
    category: 'scheduledEvent',
    searchableFields: ['eventId', 'eventName', 'changedProperty', 'oldValue', 'newValue', 'updaterId'],
    includeInChoices: false,
  },
};
