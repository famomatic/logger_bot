...
export const eventConfigurations: Record<string, EventConfig> = {
    ...
    guildMemberNicknameUpdate: {
        ...
        category: 'member',
        searchableFields: ['targetUserId', 'targetUserTag', 'oldNickname', 'newNickname'],
        includeInChoices: false,
    },
    guildMemberRoleUpdate: {
        eventName: 'GuildMemberRoleUpdate',
    ...
    guildMemberAvatarUpdate: {
        eventName: 'GuildMemberAvatarUpdate',
        friendlyName: '멤버 아바타 변경',
        dbEventType: 'guildMemberAvatarUpdate',
        category: 'member',
        searchableFields: ['targetUserId', 'targetUserTag', 'oldAvatarURL', 'newAvatarURL'],
        includeInChoices: false,
    },
    guildMemberTimeoutAdd: {
        eventName: 'GuildMemberTimeoutAdd',
        friendlyName: '멤버 타임아웃 부여',
        dbEventType: 'guildMemberTimeoutAdd',
        category: 'member',
        searchableFields: ['targetUserId', 'targetUserTag', 'timeoutUntil', 'executorUserId'],
        includeInChoices: false,
    },
    guildMemberTimeoutRemove: {
        eventName: 'GuildMemberTimeoutRemove',
        friendlyName: '멤버 타임아웃 해제',
        dbEventType: 'guildMemberTimeoutRemove',
        category: 'member',
        searchableFields: ['targetUserId', 'targetUserTag', 'executorUserId'],
        includeInChoices: false,
    },
    guildBanAdd: {
    ...
    voiceStateUpdateServerMute: {
        eventName: 'VoiceStateUpdateServerMute',
        friendlyName: '서버 음소거 변경',
        dbEventType: 'voiceStateUpdateServerMute',
        category: 'voice',
        searchableFields: ['userId', 'userTag', 'oldStatus', 'newStatus', 'executorUserId'],
        includeInChoices: false,
    },
    voiceStateUpdateServerDeaf: {
        eventName: 'VoiceStateUpdateServerDeaf',
    ...
    voiceStateUpdateSelfMute: {
        eventName: 'VoiceStateUpdateSelfMute',
        friendlyName: '자체 음소거 변경',
        dbEventType: 'voiceStateUpdateSelfMute',
        category: 'voice',
        searchableFields: ['userId', 'userTag', 'muted', 'channelId', 'channelName'],
        includeInChoices: false,
    },
    voiceStateUpdateSelfDeaf: {
        eventName: 'VoiceStateUpdateSelfDeaf',
        friendlyName: '자체 청각차단 변경',
        dbEventType: 'voiceStateUpdateSelfDeaf',
        category: 'voice',
        searchableFields: ['userId', 'userTag', 'deafened', 'channelId', 'channelName'],
        includeInChoices: false,
    },
    voiceStateUpdateStreaming: {
        eventName: 'VoiceStateUpdateStreaming',
        friendlyName: '화면공유 상태 변경',
        dbEventType: 'voiceStateUpdateStreaming',
        category: 'voice',
        searchableFields: ['userId', 'userTag', 'streaming', 'channelId', 'channelName'],
        includeInChoices: false,
    },
    voiceStateUpdateVideo: {
        eventName: 'VoiceStateUpdateVideo',
        friendlyName: '비디오 상태 변경',
        dbEventType: 'voiceStateUpdateVideo',
        category: 'voice',
        searchableFields: ['userId', 'userTag', 'video', 'channelId', 'channelName'],
        includeInChoices: false,
    },
